...
var app = angular.module('DashPlayer', ['DashSourcesService', 'DashContributorsService', 'angular-flot', 'ngFileSaver']);
...
app.controller('DashController', function($scope, sources, contributors, FileSaver, Blob) {
